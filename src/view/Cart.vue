...
export default {
    ...
    data(){
        return{
            ...
            {product:{id:3, name:"Áo nỉ nam ANHTK312  - Đen, S", price:449}, quatity: 2, totalPro: 898}, 
            {product:{id:4, name:"Áo nỉ nam ANHTK314 - Đen, S", price:449}, quatity: 4, totalPro: 1796}, 
            {product:{id:5, name:"Áo nỉ nam ANHTK315 - Đen, S", price:449}, quatity: 5, totalPro: 2245}],
            totalQuatity: 0,
            moneyProv: 0,
            moneyTotal: 0,
        }
